...
public class JwtUtility {
	...
	public String generateAccessToken(User user) {
		...
		if(user == null || user.getId() == null || user.getId() == null || user.getRole() == null) {
			throw new IllegalArgumentException("user object is null or its fields have null values");
		}
		
		long expirationTimeInMilis = System.currentTimeMillis() + accessTokenExpiration * 60000;
		...
		return Jwts.builder()
				...
				.issuer(issuerName)
				.issuedAt(new Date())
				.expiration(new Date(expirationTimeInMilis))
