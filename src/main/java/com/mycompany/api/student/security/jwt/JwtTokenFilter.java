package com.mycompany.api.student.security.jwt;
...
import com.mycompany.api.student.security.CustomUserDetails;
...
public class JwtTokenFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		try {
			...
			LOGGER.info("ROLE TOKEN" + (String) claims.get("role"));
	...
	private void setAuthenticationContext(UserDetails userDetails, HttpServletRequest request) {
		...
		LOGGER.info("Role "+SecurityContextHolder.getContext().getAuthentication().getAuthorities().toString());
	}
